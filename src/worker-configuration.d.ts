/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: e241f292cafaa7e1c21c41ce55cb9220)
// Runtime types generated with workerd@1.20260801.1 2026-07-13 global_fetch_strictly_public,nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	APP_KV: KVNamespace;
	UPLOADS_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	MUMBLE_PROXY_WS_URL: "wss://voice.playdota2.win/ws";
	MUMBLE_PROXY_HEALTH_URL: "https://voice.playdota2.win/health";
	MUMBLE_PROXY_STUN_SERVERS: "stun:turn.playdota2.win:3478,turn:turn.playdota2.win:3478,turns:turn.playdota2.win:5349?transport=tcp";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MUMBLE_PROXY_WS_URL" | "MUMBLE_PROXY_HEALTH_URL" | "MUMBLE_PROXY_STUN_SERVERS">> {}
}
