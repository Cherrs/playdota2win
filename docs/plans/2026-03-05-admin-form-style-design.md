...
```css
--admin-input-border: 2px solid #e6e0f0 --admin-input-radius: 12px --admin-input-padding: 0.75rem
	1rem --admin-input-focus-border: #6b4c9a --admin-input-focus-shadow: 0 0 0 3px
	rgba(107, 76, 154, 0.15) --admin-label-color: #6b4c9a --admin-btn-radius: 12px
